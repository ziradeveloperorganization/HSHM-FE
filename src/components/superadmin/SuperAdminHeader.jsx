...
export default function SuperAdminHeader({ dark, toggleDark, toggleSidebar }) {
            ...
            {user && (
              <>
                ...
                >
                  ...
                  {!isMobile && (
                    <div style={{ marginLeft: 8, textAlign: 'left' }}>
                      ...
                      <br />
                      <IonText color="primary" style={{ fontSize: '0.7rem' }}>
                        <IonIcon icon={shieldOutline} style={{ marginRight: 4 }} />
                        Super Admin
                      </IonText>
                    </div>
                  )}
                ...
                <IonPopover
                  ...
                  side="bottom"
                  alignment="end"
                  trigger="superadmin-profile-button"
                >
                  <IonList>
                    {!showLanguageMenu ? (
                      <>
